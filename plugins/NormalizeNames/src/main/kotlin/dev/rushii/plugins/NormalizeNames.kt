...
class NormalizeNames : Plugin() {
    ...
    override fun start(ctx: Context) {
        ...
        val originalGlobalNames =
            ReflectUtils.getField(Class.forName("com.aliucord.coreplugins.rn.PatchesKt"), null, "globalNames")
        ...
        ReflectUtils.setFinalField(
            Class.forName("com.aliucord.coreplugins.rn.PatchesKt"),
            null,
            "globalNames",
            globalNamesInterceptor,
        )
