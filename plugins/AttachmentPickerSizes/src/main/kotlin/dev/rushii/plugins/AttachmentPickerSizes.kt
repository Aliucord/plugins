...
class AttachmentPickerSizes : Plugin() {
    ...
    private fun bindSizeTag(layout: ViewGroup, media: Media) {
        ...
        layout.addView(
            CardView(layout.context).apply {
                ...
                addView(
                    TextView(layout.context, null, 0, R.i.UiKit_TextAppearance_MaterialEditText_Label).apply {
                        id = sizeTextId
                        text = size
    ...
    private fun getReadableSize(sizeBytes: Long): String {
        ...
        return DecimalFormat("#,##0.#").format(sizeBytes / 1024.0.pow(digitGroups.toDouble()))
